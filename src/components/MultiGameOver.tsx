  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={leaveRoom}
          className="w-full py-3.5 rounded-2xl text-base font-black text-white bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 transition-all active:scale-95 shadow-lg"
        >
          🏠 홈으로
        </button>
      </div>
